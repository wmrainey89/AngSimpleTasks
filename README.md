...
## Structure
This lab asks you to perform various tasks, using AngularJs.

Your lab folder should consist of 1 folder, AngularJs, containing an index.html, JS file, and any CSS files.

You should complete the tasks first in the Angular folder using only the Angular.
